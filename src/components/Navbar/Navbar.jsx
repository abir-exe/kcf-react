...
const Navbar = () => {
    return (
        <div className="border-b pb-2 sticky top-0 bg-white absolute">
            <nav className="py-3">
            <div className="flex justify-between items-center">
                <div className="">
                    <div className="w-40 ml-10"><img src="../../../public/images/logo.png" alt="" /></div>
                </div>
                <ul className="flex flex-col md:flex-row lg:flex-row justify-between gap-5">
                    ...
                    <li><button
                            className="px-3 py-2 md:px-2 md:py-1 lg:px-9 lg:py-2 mt-2 bg-blue-400 text-white rounded-md hover:bg-gray-100 hover:text-blue-400"><a
                                href="#cu">Contact Us</a></button></li>
                </ul>
            </div>
        </nav>
        </div>
